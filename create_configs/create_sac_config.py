    ...
    configuration["reinforcement_learning"] = {
        ...
        "parameters": {
            ...
            "specific_parameters": {
                ...
                "learn_temperature": True,  # If temperature should be learned
                "temperature": 0.001,  # Initial temperature
                ...
                "add_entropy_target": True,  # Wether to add entropy term in critic loss, default to True.
            },
        },
    }
