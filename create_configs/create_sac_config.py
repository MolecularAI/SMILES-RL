...
def main():
    ...
    save_path_config = os.path.join(log_dir, "sac_config.json")
...
def _create_json_config(
    ...
    configuration["logging"] = {
        ...
        "parameters": {
            ...
            "job_name": "sac demo",  # set an arbitrary job name for identification
    ...
    configuration["reinforcement_learning"] = {
        "method": "smiles_rl.agent.sac.SAC",
        "parameters": {
            ...
            "specific_parameters": {
                ...
                "discount_factor": 1,  #
                "tau": 0.99,  # Soft update factor for critic. Fixed to 0.99 for average actor
                "learn_temperature": True,  # True # If temperature should be learned
                "temperature": 0.001,  # 0.2  # Initial temperature
                "use_log_temperature": False,  # If learnt temperature should be logged
                "max_grad_norm": 0.5,  # Maxmim gradient normalization for L2 regularization
                "average_network": True,  # Default: False
                "average_network_scale": 0.5,  # Default: 1.0
                "clip_critic": True,
                "use_local_actor_loss": False,  # Default: False
                "target_entropy": 0.3,
                "learning_rate_critic": 0.0001,
                "learning_rate_actor": 0.0001,
                "learning_rate_temperature": 0.0001,
                "reset_critic1": False,  # Wether to reset output layer of pre-trained model, which is used as critic1
                "reset_critic2": False,  # Wether to reset output layer of pre-trained model, which is used as critic2
                "add_entropy_target": True,  # Wether to add entropy term in ciritc loss, default: True, best: False
            },
        },
    }
